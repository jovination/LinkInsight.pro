      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              The most powerful link analysis tool for developers, marketers, and SEO professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/changelog" className="text-muted-foreground hover:text-foreground text-sm">Changelog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/api" className="text-muted-foreground hover:text-foreground text-sm">API Reference</Link></li>
              <li><Link to="/status" className="text-muted-foreground hover:text-foreground text-sm">Status</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/legal/privacy" className="text-muted-foreground hover:text-foreground text-sm">Privacy</Link></li>
              <li><Link to="/legal/terms" className="text-muted-foreground hover:text-foreground text-sm">Terms</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} LinkChecker. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/legal/cookies" className="text-sm text-muted-foreground hover:text-foreground">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
